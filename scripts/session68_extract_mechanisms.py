...
def load_papers():
    """Load selected papers for extraction"""
    with open('examples/session68_selected_papers.json', 'r') as f:
        data = json.load(f)
    return data['papers']

def extract_mechanisms_manually():
    """Manually extract mechanisms from papers"""

    papers = load_papers()

    # Based on reading the abstracts, I'll extract mechanisms from papers that have clear structural patterns
    mechanisms = []

    # Paper 524 - q-bio.CB - Diffusion solver
    mechanisms.append({
        "paper_id": 524,
        "subdomain": "q-bio.CB",
    ...
    # Paper 650 - physics.chem-ph - Hierarchical optimization
    mechanisms.append({
        "paper_id": 650,
    ...
    # Paper 696 - physics.plasm-ph - Dynamic charging soliton
    mechanisms.append({
        "paper_id": 696,
    ...
    # Paper 701 - physics.plasm-ph - Larmor coupling
    mechanisms.append({
        "paper_id": 701,
        "subdomain": "physics.plasm-ph",
    ...
    # Paper 747 - math.NA - Cancer chemotaxis model
    mechanisms.append({
        "paper_id": 747,
        "subdomain": "math.NA",
    ...
    # Paper 785 - physics.ao-ph - Model selection trade-offs
    mechanisms.append({
        "paper_id": 785,
    ...
    # Paper 787 - physics.ao-ph - Hybrid modeling
    mechanisms.append({
        "paper_id": 787,
        "subdomain": "physics.ao-ph",
    ...
    # Paper 998 - cs.NI - Cooperative caching
    mechanisms.append({
        "paper_id": 998,
        "subdomain": "cs.NI",
    ...
    # Paper 1013 - cs.LG - Epistemic uncertainty
    mechanisms.append({
        "paper_id": 1013,
        "subdomain": "cs.LG",
    ...
    # Paper 1042 - cs.AI - Communication protocols
    mechanisms.append({
        "paper_id": 1042,
        "subdomain": "cs.AI",
    ...
    # Paper 1072 - stat.ML - Identifiability
    mechanisms.append({
        "paper_id": 1072,
        "subdomain": "stat.ML",
    ...
    # Paper 1103 - cs.CV - Continual learning
    mechanisms.append({
        "paper_id": 1103,
        "subdomain": "cs.CV",
    ...
    # Paper 1139 - cs.DC - Distributed consensus
    mechanisms.append({
        "paper_id": 1139,
        "subdomain": "cs.DC",
    ...
    # Paper 1156 - eess.SP - Compressed sensing
    mechanisms.append({
        "paper_id": 1156,
        "subdomain": "eess.SP",
    ...
    # Paper 1187 - q-bio.NC - Neural criticality
    mechanisms.append({
        "paper_id": 1187,
        "subdomain": "q-bio.NC",
    ...
    # Paper 1193 - cs.RO - Swarm coordination
    mechanisms.append({
        "paper_id": 1193,
        "subdomain": "cs.RO",
    ...
    # Paper 1207 - cond-mat.stat-mech - Phase transitions
    mechanisms.append({
        "paper_id": 1207,
    ...
    # Paper 1232 - cs.GT - Game-theoretic learning
    mechanisms.append({
        "paper_id": 1232,
        "subdomain": "cs.GT",
    ...
    # Paper 1267 - quant-ph - Quantum error correction
    mechanisms.append({
        "paper_id": 1267,
        "subdomain": "quant-ph",
    ...
    # Paper 1289 - physics.soc-ph - Opinion dynamics
    mechanisms.append({
        "paper_id": 1289,
    ...
    # Paper 1315 - stat.ME - Causal discovery
    mechanisms.append({
        "paper_id": 1315,
        "subdomain": "stat.ME",
    ...
    # Paper 1342 - cs.NE - Evolutionary algorithms
    mechanisms.append({
        "paper_id": 1342,
        "subdomain": "cs.NE",
    ...
    # Paper 1376 - eess.SY - Control systems
    mechanisms.append({
        "paper_id": 1376,
        "subdomain": "eess.SY",
    ...
    # Paper 1398 - cs.IT - Information theory
    mechanisms.append({
        "paper_id": 1398,
        "subdomain": "cs.IT",
    ...
    # Paper 1412 - cond-mat.soft - Active matter
    mechanisms.append({
        "paper_id": 1412,
    ...
    # Paper 1467 - cs.SE - Software testing
    mechanisms.append({
        "paper_id": 1467,
        "subdomain": "cs.SE",
    ...
    # Paper 1489 - physics.flu-dyn - Turbulence
    mechanisms.append({
        "paper_id": 1489,
    ...
    # Paper 1513 - cs.CL - Language models
    mechanisms.append({
        "paper_id": 1513,
        "subdomain": "cs.CL",
    ...
    # Paper 1543 - math.OC - Bilevel optimization
    mechanisms.append({
        "paper_id": 1543,
        "subdomain": "math.OC",
    ...
    # Paper 1572 - cond-mat.mes-hall - Quantum transport
    mechanisms.append({
        "paper_id": 1572,
    ...
    # Paper 1634 - astro-ph.GA - Galaxy formation
    mechanisms.append({
        "paper_id": 1634,
    ...
    # Paper 1668 - cs.LG - Meta-learning
    mechanisms.append({
        "paper_id": 1668,
        "subdomain": "cs.LG",
...
def save_mechanisms(mechanisms):
    """Save extracted mechanisms to JSON file"""
    output = {
        "session": 68,
    ...
    with open('examples/session68_extracted_mechanisms.json', 'w') as f:
        json.dump(output, f, indent=2)

    print(f"Extracted {len(mechanisms)} mechanisms")
    print(f"Saved to examples/session68_extracted_mechanisms.json")

    # Show domain distribution
    domains = {}
    for m in mechanisms:
        domain = m['subdomain'].split('.')[0] if '.' in m['subdomain'] else m['subdomain']
        domains[domain] = domains.get(domain, 0) + 1

    print("\nDomain distribution of extracted mechanisms:")
    for domain, count in sorted(domains.items(), key=lambda x: x[1], reverse=True):
        print(f"  {domain}: {count} mechanisms")

    # Show quality distribution
    quality = {}
    for m in mechanisms:
        q = m['extraction_quality']
        quality[q] = quality.get(q, 0) + 1

    print("\nExtraction quality distribution:")
    for q, count in sorted(quality.items()):
        print(f"  {q}: {count} mechanisms")

def main():
    mechanisms = extract_mechanisms_manually()
    save_mechanisms(mechanisms)
